package com.ch13.class03.step05;
...
public class SpringOSIVExample01 implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) {
		...
		log.info("originalMember : {}", originalMember.getName());
	}

	public static void main(String[] args) {
		SpringApplication.run(SpringOSIVExample01.class, args);
	}
}
